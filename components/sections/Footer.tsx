...
export default function Footer() {
  return (
    <footer className="relative mx-auto mt-56 overflow-x-clip">
      ...
      <div className="absolute inset-x-0 -top-40 h-[340px] w-[130%] -left-[15%] bg-[radial-gradient(ellipse_at_center,_white_0%,_#F0EBFF_40%,_transparent_60%)] opacity-80 blur-[30px] rounded-t-[50%_100%]"></div>
      
      {/* Layer 6: Sharp white border glow */}
      <div className="absolute inset-x-0 -top-36 h-[320px] w-[127%] -left-[13.5%] bg-white opacity-50 blur-[15px] rounded-t-[50%_100%]"></div>
      
      {/* Black arc (main element) */}
      <div className="absolute inset-x-0 -top-32 h-[1000px] w-[200%] -left-1/2 bg-black rounded-t-[50%_100%] shadow-[0_0_120px_rgba(255,255,255,0.3)]"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto ">
        ...
        <div className="text-center pb-12">
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold text-white font-space-grotesk leading-none">
            Viper Network
          </h1>
        </div>
      </div>
