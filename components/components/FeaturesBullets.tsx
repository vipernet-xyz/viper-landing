export default function FeaturesBullets() {
  return (
    <div className="flex justify-between gap-8 w-full items-stretch lg:flex-col lg:w-1/3 lg:gap-12">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="w-full h-1 bg-gradient-to-r from-[#473782] to-[#BCAFEB] mt-4" />
      </div>
    </div>
  )
}
